<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBootstrap.Master" AutoEventWireup="true" CodeBehind="eventDetailsTabOne.aspx.cs" Inherits="FinalProj.Enquiry" %>
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-12 col-lg-12">
					<ul class="nav nav-tabs">
						<li class="nav-item">
							<a class="nav-link active" href="/eventDetailsTabOne.aspx">About</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="/eventDetailsTabTwo.aspx">Attendees</a>
						</li>
